...
# Extract the column from the subsetted object
...
# Replace values in the larger object
...
```{r}
pre_res.cc <- readRDS("cellchat_pre_res.rds") # Make sure the two cc.obj are loaded
